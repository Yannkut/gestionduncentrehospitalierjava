...
public class Actionnaire  implements Serializable {
	 ...
	 */
	 @Transient
	public static final String SEQUENCE_NAME = "actionnaire_sequence";
	...
	@Id
		...
		public Actionnaire(int id, String name, String sexe, String ville, String job,int age) {
		...
		public Actionnaire(String name, String sexe, String ville, String job, int age) {
			super();
			this.name = name;
			this.sexe = sexe;
			this.ville = ville;
