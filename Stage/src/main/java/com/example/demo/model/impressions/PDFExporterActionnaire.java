...
public class PDFExporterActionnaire {
	
  

	private List<Actionnaire> listActionnaires;
	
  
	  public PDFExporterActionnaire(List<Actionnaire> listActionnaires) {
			super();
			this.listActionnaires = listActionnaires;
		}
	...
	private void writeTableData(PdfPTable collection) {
        for (Actionnaire actionnaire : listActionnaires) {
            collection.addCell(String.valueOf(actionnaire.getId()));
            collection.addCell(actionnaire.getName());
            collection.addCell(actionnaire.getSexe());
            collection.addCell(actionnaire.getVille());
            collection.addCell(actionnaire.getJob());
            collection.addCell(String.valueOf(actionnaire.getAge()));
        }
    }
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("La Liste des Actionnaires", font);
